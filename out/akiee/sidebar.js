...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),akiee.handlers.onclick_hdln], null),(cljs.core.truth_((function (){var and__4708__auto__ = akiee.app_db.selected.call(null);
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#sidebar-project","div#sidebar-project",1692106605),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),akiee.handlers.onclick_project], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.details-left","span.details-left",585347392),"Project:"], null),(cljs.core.truth_((function (){var and__4708__auto__ = akiee.app_db.selected.call(null);
if(cljs.core.truth_(and__4708__auto__)){
return cljs.core._EQ_.call(null,akiee.app_db.editable.call(null),"project");
} else {
return and__4708__auto__;
}
})())?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select#sidebar-task-project.form-control","select#sidebar-task-project.form-control",-556150370),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"name","name",1843675177),"task-project",new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),new cljs.core.Keyword(null,"project","project",1124394579).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),akiee.handlers.onblur_sidebar_project,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),akiee.handlers.onblur_sidebar_project,new cljs.core.Keyword(null,"on-change","on-change",-732046149),akiee.handlers.onblur_sidebar_project,new cljs.core.Keyword(null,"on-click","on-click",1632826543),akiee.handlers.submit_sidebar_project], null),(function (){var iter__5476__auto__ = (function iter__6449(s__6450){
...
var c__5474__auto__ = cljs.core.chunk_first.call(null,s__6450__$2);
var size__5475__auto__ = cljs.core.count.call(null,c__5474__auto__);
var b__6452 = cljs.core.chunk_buffer.call(null,size__5475__auto__);
if((function (){var i__6451 = (0);
while(true){
if((i__6451 < size__5475__auto__)){
var p = cljs.core._nth.call(null,c__5474__auto__,i__6451);
cljs.core.chunk_append.call(null,b__6452,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),p], null));

var G__6453 = (i__6451 + (1));
i__6451 = G__6453;
continue;
} else {
return true;
...
var p = cljs.core.first.call(null,s__6450__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),p], null),iter__6449.call(null,cljs.core.rest.call(null,s__6450__$2)));
}
} else {
return null;
}
...
return iter__5476__auto__.call(null,akiee.app_db.projects.call(null));
...
var style = (cljs.core.truth_((function (){var and__4708__auto__ = akiee.app_db.selected.call(null);
if(cljs.core.truth_(and__4708__auto__)){
...
var span_style = (cljs.core.truth_((function (){var and__4708__auto__ = akiee.app_db.selected.call(null);
if(cljs.core.truth_(and__4708__auto__)){
return cljs.core._EQ_.call(null,akiee.app_db.editable.call(null),"scheduled");
} else {
return and__4708__auto__;
